...
public class MenuUtil {
     ...
     */
    public static void getCreateUpdateLayoutComponentsByObject(ArrayList<Component> menuComponents, ArrayList<Runnable> getInfoAfterInput, ArrayList<Field> fields, Object objectToCreate) throws DataAccessException, IllegalAccessException {
...
//                        JOptionPane.showMessageDialog(null, "Invalid Number", "The validation failed", JOptionPane.ERROR_MESSAGE);
                ...
                getCreateUpdateLayoutComponentsByObject(menuComponents, getInfoAfterInput, addressFields, address);
    ...
    public static void getDisplayInfoLayoutComponentsFromFields(ArrayList<Component> menuComponents, ArrayList<Field> fields, Object objectToDisplay) throws IllegalAccessException {
