...
public class EmployeeUpdateMenu extends JFrame {
    ...
    private void initializeVariables() throws DataAccessException, IllegalAccessException {
        ...
        getCreateUpdateLayoutComponentsByObject(menuComponents, runGetInfo, employeeFields, employee);

        /**
         * When the submit button is clicked, the runGetInfo Functions will pull and map the data to the Employee provided to getCreateUpdateLayoutComponentsByObject
