...
public class CreateTicketMenu extends JFrame {
    ...
    private void initComponentsNewTicket() {
        ...
        submitTicket.addActionListener(e -> submitTicketActionPerformed());
    ...
    private void searchButtonMouseClicked() {
        List<Ticket> tickets;
        try {
            tickets = ticketController.getAllTickets(true).stream()
                    .filter(e -> e.getCustomer().getEmail().equals(email.getText())).collect(Collectors.toList());
    ...
    private void initComponentsOldTicket() {
        ...
        searchButton.addActionListener(e -> {
            try {
                ...
                if (customerController.findCustomerByEmail(email.getText(), false) != null) {
