...
public class CustomerUpdateMenu extends JFrame {
    ...
    private void initializeVariables() throws DataAccessException, IllegalAccessException {
        ...
        getCreateUpdateLayoutComponentsByObject(menuComponents, runGetInfo, customerFields, customer);

        /**
         * When the submit button is clicked, the runGetInfo Functions will pull and map the data to the Customer provided to getCreateUpdateLayoutComponentsByObject
