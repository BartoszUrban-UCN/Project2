...
import static gui.MenuUtil.getCreateUpdateLayoutComponentsByObject;
...
public class DepartmentUpdateMenu extends JFrame{
    ...
    private void initializeVariables() throws DataAccessException, IllegalAccessException {
        ...
        getCreateUpdateLayoutComponentsByObject(menuComponents, runGetInfo, departmentFields, department);

        /**
         * When the submit button is clicked, the runGetInfo Functions will pull and map the data to the Department provided to getCreateUpdateLayoutComponentsByObject
